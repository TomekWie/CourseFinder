...
class CourseController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $courses = $em->getRepository('CourseFinderBundle:Course')->findAll();
    ...
    {
        $course = new Course();
        $form = $this->createForm('CourseFinderBundle\Form\CourseType', $course);
    ...
    {
        $deleteForm = $this->createDeleteForm($course);
        $editForm = $this->createForm('CourseFinderBundle\Form\CourseType', $course);
