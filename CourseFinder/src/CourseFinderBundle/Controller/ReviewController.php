...
class ReviewController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $reviews = $em->getRepository('CourseFinderBundle:Review')->findAll();
    ...
    {
        $review = new Review();
        $form = $this->createForm('CourseFinderBundle\Form\ReviewType', $review);
    ...
    {
        $deleteForm = $this->createDeleteForm($review);
        $editForm = $this->createForm('CourseFinderBundle\Form\ReviewType', $review);
