...
class SchoolController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $schools = $em->getRepository('CourseFinderBundle:School')->findAll();
    ...
    {
        $school = new School();
        $form = $this->createForm('CourseFinderBundle\Form\SchoolType', $school);
    ...
    {
        $deleteForm = $this->createDeleteForm($school);
        $editForm = $this->createForm('CourseFinderBundle\Form\SchoolType', $school);
